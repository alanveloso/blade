...
/// @dev Selection is the installed pool in order, minus installations whose `BehaviorFilter`
///      does not match this trigger (default filter matches every accepted trigger).
